...
class CreateRecordForm(forms.ModelForm):
    ...
    state = forms.CharField(required=True, label='',max_length=30, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'State'}))
    zipcode = forms.CharField(required=True, label='',max_length=30, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Zipcode'}))
